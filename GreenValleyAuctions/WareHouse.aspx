    ...
    <asp:Table ID="tblHome" runat="server">
        <asp:TableRow>
            <asp:TableCell ColumnSpan="2">
                <asp:TextBox ID="txtSearch" runat="server" placeholder="Search Warehouse"></asp:TextBox>
                <asp:Button ID="btnSearch" runat="server" Text="Search" OnClick="btnSearch_Click" />
            </asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
            <asp:TableCell>
                <asp:Button ID="btnleft" runat="server" Text="Left" OnClick="btnleft_Click" />
            </asp:TableCell>
            <asp:TableCell>
                <asp:Button ID="btnRight" runat="server" Text="Right" OnClick="btnRight_Click"/>
            </asp:TableCell>
            <asp:TableCell>
                <asp:Button ID="btnTrailer" runat="server" Text="Trailer"  OnClick="btnTrailer_Click"/>
            </asp:TableCell>
        </asp:TableRow>
    </asp:Table>
    <asp:Table ID="Left" runat="server" Visible="false">
        <asp:TableRow>
            <asp:TableCell>
                <asp:Button ID="btnL1" runat="server" Text="L1" OnClick="btnL1_Click" />
            </asp:TableCell>
            <asp:TableCell>
                <asp:Button ID="btnL2" runat="server" Text="L2" OnClick="btnL2_Click"/>
            </asp:TableCell>
            <asp:TableCell>
                <asp:Button ID="btnL3" runat="server" Text="L3" OnClick="btnL3_Click" />
            </asp:TableCell>
             <asp:TableCell>
                 <asp:Button ID="btnL4" runat="server" Text="L4" OnClick="btnL4_Click" />
            </asp:TableCell>
             <asp:TableCell>
                 <asp:Button ID="btnL5" runat="server" Text="L5" OnClick="btnL5_Click" />
            </asp:TableCell>
        </asp:TableRow >
     ...
     <asp:Table ID="Right" runat="server" Visible="false">
<asp:TableRow>
            <asp:TableCell>
                <asp:Button ID="btnR1" runat="server" Text="R1" OnClick="btnR1_Click" />
            </asp:TableCell>
            <asp:TableCell>
                <asp:Button ID="btnR2" runat="server" Text="R2" OnClick="btnR2_Click"/>
            </asp:TableCell>
            <asp:TableCell>
                <asp:Button ID="btnR3" runat="server" Text="R3" OnClick="btnR3_Click" />
            </asp:TableCell>
             <asp:TableCell>
                 <asp:Button ID="btnR4" runat="server" Text="R4" OnClick="btnR4_Click" />
            </asp:TableCell>
             <asp:TableCell>
                 <asp:Button ID="btnR5" runat="server" Text="R5" OnClick="btnR5_Click" />
            </asp:TableCell>
        </asp:TableRow >
...
<asp:Table ID="Trailer" runat="server" Visible="false">
        <asp:TableRow>
            <asp:TableCell>
                <asp:Button ID="btnT1" runat="server" Text="T1" OnClick="btnT1_Click" />
            </asp:TableCell>
            <asp:TableCell>
                <asp:Button ID="btnT2" runat="server" Text="T2" OnClick="btnT2_Click"/>
            </asp:TableCell>
            <asp:TableCell>
                <asp:Button ID="btnT3" runat="server" Text="T3" OnClick="btnT3_Click" />
            </asp:TableCell>
             <asp:TableCell>
                 <asp:Button ID="btnT4" runat="server" Text="T4" OnClick="btnT4_Click" />
            </asp:TableCell>
             <asp:TableCell>
                 <asp:Button ID="btnT5" runat="server" Text="T5" OnClick="btnT5_Click" />
            </asp:TableCell>
            <asp:TableCell>
                 <asp:Button ID="btnT6" runat="server" Text="T6" OnClick="btnT6_Click" />
            </asp:TableCell>
            <asp:TableCell>
                 <asp:Button ID="btnT7" runat="server" Text="T7" OnClick="btnT7_Click" />
            </asp:TableCell>
            <asp:TableCell>
                 <asp:Button ID="btnT8" runat="server" Text="T8" OnClick="btnT8_Click" />
            </asp:TableCell>
        </asp:TableRow >
